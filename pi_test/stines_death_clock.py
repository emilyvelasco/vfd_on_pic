...
hold      = b'\xFF\x03\xA1\x03\xC7\x03\xFF\x03\xC0\x03\x89\x03\xFF\x03\xFF\x03'
...
class TwelveFlash:
  frames = (
    ...
    b'\xFF\x03\xC0\x03\xC0\x03\xFF\x01\xA4\x03\xF9\x03\xF3\x03\xFF\x03',
...
## stine pseudo code example
            pdt = YouDieOn()
            state = "pretext_display"
